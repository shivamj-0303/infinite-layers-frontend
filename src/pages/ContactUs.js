...
function ContactUs() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // TODO: Send to backend endpoint when created
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">shivamjangid0108@gmail.com</p>
            ...
            <div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+91 9057157661</p>
          ...
          <div className="lg:col-span-2">
            <form onSubmit={handleSubmit} className="bg-gray-50 rounded-lg p-8 space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-pink-500 to-orange-500 hover:from-pink-600 hover:to-orange-600 text-white font-semibold py-3 rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
        ...
        <div className="bg-gray-50 rounded-lg p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">What is your response time?</h3>
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">Yes! We specialize in custom 3D printed items. Contact us for details.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">What are your shipping options?</h3>
              <p className="text-gray-600 text-sm">We offer fast shipping across India with tracking on all orders.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">Do you offer refunds?</h3>
              <p className="text-gray-600 text-sm">Yes, we have a 30-day money-back guarantee on all products.</p>
            </div>
          </div>
        </div>
      </div>
